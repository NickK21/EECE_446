...
//     if (response[0] == 0)
//     {
//         // Successsfucl fetch, now receive the file data
...
//         int bytes_received;
//         while ((bytes_received = recv(sockfd, buf, sizeof(buf), 0)) > 0)
//         {
...
//     else
//     {
//         printf("FETCH Request Failed. File Not Available.\n");
//     }
...
void fetch(int sockfd)
{
    ...
    // New buffer for peer
    fetch_req[0] = 3;
    // memcpy(fetch_req, &fetch_action, packet_len);
